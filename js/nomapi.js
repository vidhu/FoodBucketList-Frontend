var Nom = (function () {
    ...
    return function (accessToken) {
        ...
        var Bucket = function() {
            ...
            this.addBucket = function (name, description, callback) {
                var resource = "/bucket";
                var method = "POST";
                var data = {
                    accessToken: accessToken,
            ...
            this.editBucket = function (id, name, description, callback) {
            ...
            this.deleteBucket = function (id, callback) {
            ...
            this.addItem = function (id, businessID, callback) {
            ...
            this.deleteItem = function (id, businessID, callback) {
